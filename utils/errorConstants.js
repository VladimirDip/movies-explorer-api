...
const INVALID_MOVIE_DATA_ERROR_TEXT =
  'Переданы некорректные данные в метод создания фильма.';
const INVALID_MOVIE_DATA_DELETE_ERROR_TEXT =
  'Переданы некорректные данные в метод удаления фильма.';
...
const INVALID_USER_DATA_ERROR_TEXT =
  'Переданы некорректные данные в метод создания пользователя.';
const INVALID_PROFILE_DATA_ERROR_TEXT =
...
// Other error texts
const INVALID_EMAIL_OR_PASSWORD_ERROR_TEXT =
  'Неверный электронный адрес или пароль.';
const INVALID_EMAIL_FORMAT_ERROR_TEXT =
...
const URL_NOT_FOUND_ERROR_TEXT =
  'Запрашиваемый ресурс не найден, проверьте адрес:';
const MAX_LIMIT_RATE_ERROR_TEXT =
  'Превышено ограничение количества запросов, попробуйте снова позже.';
